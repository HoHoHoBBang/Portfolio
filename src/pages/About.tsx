    ...
    >
      <div className="flex h-full w-[75%] flex-col items-center justify-center max-md:w-full">
        ...
        <p className="p-5 text-sm tracking-widest text-gray-400">
          <span className="text-white">다양한 직무 경험</span>을 통해 습득한{" "}
          <span className="text-white">문제 해결 능력</span>과{" "}
          ...
          <br />
          <br />
          이론과 실습을 통해 기본적인 개발 역량을 갖추었으며, 실무 환경에서
          빠르게 적응하고 <span className="text-white">성장</span>할 자신이
          있습니다.
          <br />
